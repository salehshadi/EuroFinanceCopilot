...
Thought: {agent_scratchpad}"""
    ...
    CognitiveSearchToolDescription = "useful for searching the finaincial information, taxation, VAT, saving and investments etc."
...
class EmployeeInfoTool(CsvLookupTool):
    ...
    def __init__(self, employee_name: str, callbacks: Callbacks = None):
        super().__init__(
            ...
            key_field="name",
            name="investments",
            description="useful for searching the finaincial information, taxation, VAT, saving and investments etc.",
            callbacks=callbacks,
        )

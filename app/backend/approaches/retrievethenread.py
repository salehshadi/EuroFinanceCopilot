...
class RetrieveThenReadApproach(AskApproach):
    ...
    system_chat_template = (
        "You are an intelligent assistant helping users with their questions about finance and taxation in Europe and about investment and money saving options. "
    ...
    question = """
'What is the tax rate on savings in Czech Republic?'

Sources:
info1.txt: A WHT rate of 15% applies to income received by resident individuals from interest and other yields from savings on deposit accounts.
"""
    answer = "A WHT rate of 15% applies to income received by resident individuals from interest and other yields from savings on deposit accounts. [info1.pdf]."
